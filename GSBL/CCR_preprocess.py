...
#in VAR files
in_folder = 'C:/Users/bwu/Desktop/Shared/RW/CCR Session/2016/07/'
...
#out folder
out_folder = 'C:/Users/bwu/Desktop/Shared/RW/CTR Files/21-JUL-16/' + 'out_GSBL/'
out_file = 'out_GSBL_exp_preprocessed_file.csv'

#open in_files
df_gpf_e = pd.read_csv(in_folder+in_file_gsf_col)
df_gpf_col = pd.read_csv(in_folder+in_file_gsf_col)
df_gsf_e = pd.read_csv(in_folder+in_file_gsf_col)
df_gsf_col = pd.read_csv(in_folder+in_file_gsf_col)
